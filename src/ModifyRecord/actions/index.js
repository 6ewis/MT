import {BillingClients, Aliases, Countries, MatterPositions, MatterSpecificAddresses} from '../config/fakeData';
import R from 'ramda';
...
// const getBillingClients = () => axios.get(`http://cpmtdev01.codandev.local:3000/billing_clients/`);
 const getMatterPositions = () => axios.get(`http://cpmtdev01.codandev.local:3000/matter_positions/${selectedIds}`);
 const getMatterSpecificAddresses = () => axios.get(`http://cpmtdev01.codandev.local:3000/matter_specific_addresses/${selectedIds}`);
